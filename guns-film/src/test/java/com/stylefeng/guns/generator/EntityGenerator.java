...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\develope\\code\\project4test\\guns-film\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mtime_actor_t"});//此处是表名
        ...
        mpg.setPackageInfo(pc);     //controller里面啥也没有可以不用生成
